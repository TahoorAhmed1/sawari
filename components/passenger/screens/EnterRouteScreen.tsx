...
export function EnterRouteScreen({ onNext, onClose }: EnterRouteScreenProps) {
  ...
  const snapPoints = React.useMemo(() => ["35%", "75%", "90%"], []);
  ...
  return (
    <View className="flex-1 bg-gray-400/60">
      ...
      <BottomSheetModal
        ...
        onDismiss={onClose}
        // This ensures the background color is consistent across the whole sheet
        backgroundStyle={{ backgroundColor: "white" }}
      >
        {/* Using BottomSheetScrollView allows the list to scroll if it exceeds the snap point height */}
        <BottomSheetScrollView
